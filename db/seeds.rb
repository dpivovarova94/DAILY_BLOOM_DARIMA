...
rose = User.create(
  ...
  password: "123456",
  avatar_url: "https://i.pinimg.com/564x/ff/61/30/ff613023b85f215ec5f6940a06ae8725.jpg"
)
...
keywords_nature = ["Sky", "Sun", "Moon", "Flowers", "Water", "Clouds", "Beach", "Trees", "Shadows"]
...
keywords_food = ["Extra Cheese", "Pizza", "Plates", "Favourite Mug", "Fruits", "Pasta", "Bread", "Dishes"]
...
Post.create!(
  date: Date.today - 10.days,
  text: "Happy in a million little ways",
  created_at: Date.today - 10.days,
  challenge: rose1
)

rose2 = Challenge.create!(
...
file = URI.open("https://res.cloudinary.com/dnx6ly8vl/image/upload/v1688920258/__bq35kq.jpg")
picture2 = Post.create!(
  date: Date.today - 11.days,
  created_at: Date.today - 11.days,
  challenge: rose2
...
file = URI.open("https://res.cloudinary.com/dnx6ly8vl/image/upload/v1688920392/__1_ayqii0.jpg")
picture3 = Post.create!(
  date: Date.today - 12.days,
  created_at: Date.today - 12.days,
  challenge: rose3
...
Post.create!(
  ...
  created_at: Date.today - 15.days,
  song_url: "https://open.spotify.com/intl-de/track/1JhKbaSsS9yKMP4whv7bjS?si=6c7cea20884d475f",
  challenge: rose4
)

rose5 = Challenge.create!(
  keyword: Keyword.find_by(name: "Inner Peace"),
  user: User.find_by(username: "Rose"),
...
Post.create!(
  ...
  poem: "In the garden's haven, life's harmony takes flight,
  Where blossoms bloom in rhythm, bathed in golden light.",
  created_at: Date.today - 17.days,
  challenge: rose5
)

rose6 = Challenge.create!(
...
file = URI.open("https://res.cloudinary.com/dnx6ly8vl/image/upload/v1688921581/oqfofgnnf6vjls8bdxyb.jpg")
picture4 = Post.create!(
...
Post.create!(
  ...
  created_at: Date.today - 24.days,
  song_url: "https://open.spotify.com/intl-de/track/7037bX3jdaUWUAXL12CHGy?si=f7c04b98b10c43c8",
  challenge: rose7
)

rose8 = Challenge.create!(
  keyword: Keyword.find_by(name: "Joyful"),
  user: User.find_by(username: "Rose"),
